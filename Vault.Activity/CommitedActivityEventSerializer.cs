...
{
    public partial class CommitedActivityEvent
    {
        [CopierMethod]
        ...
        public static void Serializer(object untypedInput, ISerializationContext context, Type expected)
        {
            ...
            SerializationManager.SerializeInner(input.CheckpointToken, context, typeof(long));
        ...
        public static Object Deserializer(Type expected, IDeserializationContext context)
        {
            ...
            result.CheckpointToken = (long)SerializationManager.DeserializeInner(typeof(long), context);
