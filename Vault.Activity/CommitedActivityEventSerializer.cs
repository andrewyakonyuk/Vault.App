...
namespace Vault.Activity
{
    public partial class CommitedActivityEvent
    {
        ...
        public static void Serializer(object untypedInput, BinaryTokenStreamWriter stream, Type expected)
        {
            ...
            SerializationManager.SerializeInner(input.CheckpointToken, stream, typeof(long));
        ...
        public static Object Deserializer(Type expected, BinaryTokenStreamReader stream)
        {
            ...
            result.CheckpointToken = (long)SerializationManager.DeserializeInner(typeof(long), stream);
