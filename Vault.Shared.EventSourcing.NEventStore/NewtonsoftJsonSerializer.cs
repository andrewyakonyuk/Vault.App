...
using ISerialize = NEventStore.Serialization.ISerialize;
...
namespace Vault.Shared.EventSourcing.NEventStore
{
    public class NewtonsoftJsonSerializer : ISerialize
    {
        ...
        public NewtonsoftJsonSerializer(SerializationBinder binder = null, params Type[] knownTypes)
        {
            ...
            untypedSerializer.Binder = typedSerializer.Binder = binder;
            ...
            this.knownTypes = ((types != null) ? types : this.knownTypes);
        }
        ...
        public virtual T Deserialize<T>(Stream input)
        {
            ...
            {
                result = Deserialize<T>(new JsonTextReader(streamReader));
            }
            return result;
        }
